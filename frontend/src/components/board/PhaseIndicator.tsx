...
const PHASE_INFO: Record<GamePhase, { label: string; icon: string; color: string; hint: string; step?: string }> = {
  ...
  [GamePhase.BOUNTY_ROLL]: { label: '喋血悬赏', icon: '🎲', color: '#8b0000', hint: '悬赏金注入奖池', step: '❶' },
  [GamePhase.DRAW_MARKET]: { label: '汲取与黑市', icon: '🃏', color: '#b8860b', hint: '抽牌 + 黑市交易', step: '❷' },
  [GamePhase.CHANT_SCORE]: { label: '咏唱计分', icon: '✨', color: '#9b59b6', hint: '组合凑分 → 注入秘力熔炉', step: '❸' },
  [GamePhase.AMBUSH_DECLARE]: { label: '突袭宣告', icon: '⚡', color: '#ff4500', hint: '出牌争夺秘力熔炉', step: '❹' },
  [GamePhase.AMBUSH_DEFEND]: { label: '突袭抉择', icon: '🛡️', color: '#ff6347', hint: '怯战 / 拆穿 / 迎战', step: '❹' },
  [GamePhase.BLOCKADE_END]: { label: '暗封锁', icon: '🔒', color: '#2ecc71', hint: '暗置封锁牌 — 对手不可见', step: '❺' },
